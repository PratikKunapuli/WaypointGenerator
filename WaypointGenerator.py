...
class MyCanvas(wx.ScrolledWindow):
    ...
    def OnClick(self, event):
        ...
        scalingFactorX = 54.0/(3371.0-607.0)
        scalingFactorY = 27.0/(210.0-1583.0)
        #print '%.3f, %.3f' %((pos.x-607.0)*scalingFactorX, (pos.y-897)*scalingFactorY)
        print '%.3f, %.3f' %((pos.y-897)*scalingFactorY,(pos.x-607.0)*scalingFactorX)
